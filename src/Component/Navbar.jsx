...
import toggleSound from '../assets/context/select-button-ui-395763.mp3'; // Import the sound file with a valid identifier
...
const Navbar = ({ isDark, toggleTheme }) => {
  ...
  return (
    ...
    <div className='flex justify-between items-center px-6 my-4  mb-4 w-full'>
      ...
      <div className='flex items-center gap-6'>
        {/* Theme Toggle Button */}
        <button
          onClick={handleToggleTheme} // Use new handler to play sound and toggle theme
