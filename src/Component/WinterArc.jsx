...
{/*--------------------------------------------------------------day-38-------------------------------------------------------------------- */}
          ...
          <div className="mt-6 sm:mt-8 flex flex-wrap gap-3 sm:gap-4 pb-8 sm:pb-10">
            ...
            >
              {/* X Logo - Top Right */}
              <a 
                href="https://x.com/Bokinsha/status/2004584040935166230" 
                target="_blank"
                rel="noopener noreferrer"
                className="absolute top-3 right-3 sm:top-4 sm:right-4 hover:opacity-70 transition-opacity"
              >
              ...
              <div className={`mt-2 sm:mt-3 text-[9px] sm:text-[10px] md:text-[11px]
                ...
                ${isDark ? 'text-gray-300' : 'text-gray-800'}`}>
                <p className="font-semibold mb-1 sm:mb-2">Today's work</p>
               <p>- Daily DSA 2 hour straight practice , 1hr SQL. </p>
               <p>- Connect Backend of http://hayarnav.xyz for Personal bot</p>
               <p>- figure out what is wrong with vynix video streaming .</p>
               <p>- (if time left) DBMS and Oops Revision.</p>
...
{/*--------------------------------------------------------------day-46-------------------------------------------------------------------- */}
          ...
          <div className="mt-6 sm:mt-8 flex flex-wrap gap-3 sm:gap-4 pb-8 sm:pb-10">
            ...
            >
              {/* X Logo - Top Right */}
              <a 
                href="https://x.com/Bokinsha/status/2006720879242432559" 
                target="_blank"
                rel="noopener noreferrer"
                className="absolute top-3 right-3 sm:top-4 sm:right-4 hover:opacity-70 transition-opacity"
              >
              ...
              <div className={`mt-2 sm:mt-3 text-[9px] sm:text-[10px] md:text-[11px]
                ...
                ${isDark ? 'text-gray-300' : 'text-gray-800'}`}>
                <p className="font-semibold mb-1 sm:mb-2">Today's work</p>
               <p>- DSA Problem solving (Interview style with AI) </p>
               <p>- JavaScript and express in-depth understanding , reading docs and interview style discussion with (AI).</p>
               <p>- work on Vynix || work on http://hayarnav.xyz bot bug fixing .</p>
