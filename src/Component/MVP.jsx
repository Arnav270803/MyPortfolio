...
// ProcesG Experience
const ProcesGExperience = ({ isDark }) => {
  ...
  return (
    <div className={`pb-2 border-b ${isDark ? 'border-gray-800' : 'border-gray-200'}`}>
      ...
      <div className={`mb-3 px-6 leading-relaxed text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
        Building ProcesG, a multi-tenant ESG/BRSR data management platform that helps organisations configure annual reporting requirements, collect BRSR and GHG data, manage role-based teams, calculate emissions, and maintain audit-ready sustainability records.
      </div>
        ...
        <div className='py-2 px-6'>
          <div className='px-3'>
            <p className={`text-sm mb-1 font-medium transition duration-200 ease-in-out transform hover:scale-105 hover:text-white hover:underline ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              •<span className='pl-2'>Built company onboarding and Google authentication.</span>
            </p>
            <p className={`text-sm mb-1 font-medium transition duration-200 ease-in-out transform hover:scale-105 hover:text-white hover:underline ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              •<span className='pl-2'>Created reporting-year-specific BRSR and GHG configurations.</span>
            </p>
            <p className={`text-sm mb-1 font-medium transition duration-200 ease-in-out transform hover:scale-105 hover:text-white hover:underline ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              •<span className='pl-2'>Implemented role-based access for administrators and employees.</span>
            </p>
            <p className={`text-sm mb-1 font-medium transition duration-200 ease-in-out transform hover:scale-105 hover:text-white hover:underline ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              •<span className='pl-2'>Designed ESG data-entry, emissions-calculation, and audit-history workflows.</span>
            </p>
            <p className={`text-sm mb-4 font-medium transition duration-200 ease-in-out transform hover:scale-105 hover:text-white hover:underline ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              •<span className='pl-2'>Developed the responsive frontend, REST APIs, and relational database architecture.</span>
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className={`w-full ${isDark ? 'bg-neutral-900' : 'bg-zinc-50'}`}>
      ...
      <div className="space-y-4">
        <ProcesGExperience isDark={isDark} />
