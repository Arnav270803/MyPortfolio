    ...
    <div className={`blueprint relative bg-paper text-ink min-h-screen transition-colors duration-300 ${isDark ? 'theme-dark' : ''}`}>
      ...
      <div className="relative mx-auto max-w-[768px] border-x border-rule min-h-screen">
        ...
        <div className="hidden xl:block font-hand text-cobalt" aria-hidden="true">
          <p className="absolute -right-[210px] top-[280px] text-[20px] leading-[26px] rotate-[6deg]">
            progress<br />leaves a<br />trace
          </p>
          <svg viewBox="0 0 60 40" className="absolute -right-[186px] top-[356px] w-[54px]" fill="none" stroke="currentColor" strokeWidth="1.2">
            <path d="M50 4C38 12 24 22 10 34" strokeLinecap="round" />
            <path d="M8 22l-2 14 13-4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
